...
function Searchbar(props) {
  ...
  return (<>
    <div className='bg-light d-flex justify-content-center align-items-center rounded my-2 border border-light'>
      <input className='form-control bg-light border-0' id='search' placeholder={props.placeholder} onChange={checkLength} ref={query} />
      {(progress) ?
