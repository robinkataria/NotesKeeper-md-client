            ...
            <div className='sheild-panel d-flex justify-content-center align-items-center'>
                <div className='col-12 col-md-6 col-lg-6 bg-white rounded py-2' >
                    <form onSubmit={submitForm} className='d-flex justify-content-between flex-column ' style={{ height: '60vh' }}>
                        <div>
                            <label className='h5 mt-3 mb-2'>Enter the title of the Task</label>

                            <div className='form-group my-2'>
                                <input className='form-control' autoFocus="true" id='title' ref={taskTitle} defaultValue={(props.mode === 'edit') ? props.title : ''} required />
                            </div>

                            <div className='form-group my-2'>
                                <label className='h5 mt-3 mb-2'>Description</label>
                                <label class="fm">&nbsp;&nbsp;remaining characters {rem.rem}/200</label>
                                <textarea rows="4" className='form-control' id='desc' onChange={checkCount} value={rem.val} ref={taskDescription} />
                            </div>

                            <div className='form-group my-2'>
                                <label className='h5 mt-3 mb-2'>Deadline to complete the task</label>
                                <DateTimePicker
