    ...
    return (<>
        ...
        <div className='border border-dark rounded m-2 '>
            ...
            <div className={((props.completed) ? info : (date.getTime() > (new Date()).getTime()) ? white : warning)}>
                <div className='text-dark text-break mt-2 mb-3'>
                    <span className='h5' >Title: </span>
                    <span className='h6' >{props.title}</span>
                </div>

                {(props.description === '') ? <></> : <div className='text-dark text-break mb-3'>
                    <span className='h6' >Details: </span>
                    <span className='fm'>{props.description}</span>
                </div>}

                {(props.completed) ? <></> : <div className='mb-2 pl-3 pt-3 rounded text-break' style={{ border: '1px dashed grey', maxWidth: '120px' }}>
                    <p className='h6' >Deadline</p>
                    <p className='fm'>
