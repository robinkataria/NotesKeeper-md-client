                    ...
                    <div className='col-12 col-md-10 col-lg-8 my-2'>
                        <div className='my-1 d-flex justify-content-between align-items-center'>
                            ...
                            <div className='d-flex justify-content-center align-items-center' >
                                ...
                                <Searchbar type='todolist' placeholder="Seach your task" todo_id={props.todo_id} setsearch={setsearch} />

                                {(progress.flag && progress.button === 'all') ? <CircularProgress /> :
                                    <button className='mx-2 fm btn btn-danger' disabled={progress.flag} onClick={() => deleteTasks('all')}>
                                        Delete all tasks
                                    </button>}
