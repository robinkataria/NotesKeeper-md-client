                ...
                <div className='d-flex justify-content-center'>
                    <div className='col-12 col-md-10 col-lg-8 my-2'>
                        <div className='my-3'>
                            <Breadcrumbs aria-label="breadcrumb">
                                ...
                                <div className='form-group my-2'>
                                    <input className='form-control' placeholder="title of the note" type='text' ref={name} value={data.name.value} onChange={handleNameChange} />
                                    {(err.name.exist === 1) ?
                                        <Fade in={true}>
                        ...
                        <div className='form-group my-3'>
                            <label>Commit changes &nbsp;<small className='text-muted'>remaining characters {data.message.rem}/100</small></label>
                            <input className='form-control' placeholder="Commit message" ref={message} type='text' onChange={handleCommitChange} value={data.message.value} />
                        </div>
                        ...
                        <div className='form-group my-3 d-flex justify-content-start'>
                            <button className='btn btn-outline-danger mr-auto' disabled={progress} onClick={() => history.push('/readnotebook/' + (props.notebook_id || ''))}>
                                Cancel
                                </button>
