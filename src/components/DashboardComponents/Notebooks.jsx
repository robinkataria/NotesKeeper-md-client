                ...
                <div className='d-flex justify-content-center'>
                    <div className='col-12 col-md-10 col-lg-8 my-2'>
                        <div className='d-flex align-items-center my-3'>
                            <Link to='/' className='h3 my-auto text-decoration-none text-dark mr-auto' onClick={() => setreset(!reset)}>
                                <FontAwesomeIcon icon={faBookmark} /> Notebooks
                            </Link>

                            <Searchbar type='notebooks' placeholder="Search your notebook" setsearch={setsearch} />
