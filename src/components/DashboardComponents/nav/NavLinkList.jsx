...
export default function NavLinkList(props){
    ...
    let inactive ="text-decoraton-none rounded-pill btn btn-outline-dark fm px-2"
    return (
        <div className="navbar-nav mx-auto ">
            <ul className='d-flex rounded-pill list-unstyled p-1 bg-light'>
                <li className="nav-item mr-1 my-1">
                    <Link className={(state === 'notebooks')?active:inactive}
                ...
                <li className="nav-item ml-1 my-1">
                    <Link className={(state === 'todos')?active:inactive}
